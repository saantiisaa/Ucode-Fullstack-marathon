...
function toggleButtons() {
    ...
    const additionalButtonsSecond = document.getElementById('additionalButtonsSecond');

    if (buttons.style.display === 'none') {
        buttons.style.display = 'flex';
        arrowButton.innerHTML = '&rarr;';
        additionalButtons.style.display = 'none';
        additionalButtonsSecond.style.display = 'none';
    } else {
...
function toggleButtonsSecond() {
    const buttons = document.getElementsByClassName('buttons')[0];
    const arrowButton = document.getElementById('arrow');
    const additionalButtons = document.getElementById('additionalButtons');
    const additionalButtonsSecond = document.getElementById('additionalButtonsSecond');

    if (additionalButtonsSecond.style.display === 'none') {
        buttons.style.display = 'none';
        arrowButton.innerHTML = '&rarr;';
        additionalButtons.style.display = 'none';
        additionalButtonsSecond.style.display = 'flex';
    } else {
        buttons.style.display = 'flex';
        arrowButton.innerHTML = '&larr;';
        additionalButtons.style.display = 'none';
